...
def send_mail(fromaddr, toaddr, subject, message):
    ...
    access_token, expires_in = refresh_authorization(secrets['google_client_id'], secrets['google_client_secret'], secrets['google_refresh_token'])
    ...
    server.ehlo(secrets['google_client_id'])
    server.starttls()
...
if __name__ == '__main__':
    if len(argv) == 1:
        ...
        with open(cred_path, 'r') as fp:
            ...
            refresh_token, access_token, expires_in = get_authorization(secrets['google_client_id'], secrets['google_client_secret'])
